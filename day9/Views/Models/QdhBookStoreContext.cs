...
public partial class QdhBookStoreContext : DbContext
{
    public QdhBookStoreContext()
    {
    }

    public QdhBookStoreContext(DbContextOptions<QdhBookStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-QRRSPUUF\\HUYQUACH;Database=QdhBookStore;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6B332AC90");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2073D443048");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BF479EF25");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF74473FE5");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C5BA5FE0A");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB0EF8F45B");
